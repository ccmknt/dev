...
{
    //
    protected $fillable = ['store_id','audit_status','apply_id','shop_id','app_auth_token','category_id', 'brand_name', 'brand_logo', "main_shop_name", "branch_shop_name"
    ...
    "wifi","parking","value_added","avg_price","isv_uid","licence","licence_code","licence_name","business_certificate","business_certificate_expires",
        ...
        "box","request_id","other_authorization","licence_expires","op_role","biz_version"
    ];
}
