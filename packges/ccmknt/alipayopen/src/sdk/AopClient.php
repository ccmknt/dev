<?php
namespace Alipayopen\Sdk;
use Alipayopen\Sdk\AopEncrypt;
use Alipayopen\Sdk\LtLogger;
use Alipayopen\Sdk\SignData;
use Alipayopen\Sdk\AlipayMobilePublicMultiMediaClient;
use Alipayopen\Sdk\AlipayMobilePublicMultiMediaExecute;
use Alipayopen\Sdk\EncryptResponseData;
use Alipayopen\Sdk\EncryptParseItem;
...
class AopClient
{
    ...
    protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
    {
        ...
        $logger = new LtLogger();
        $logger->conf["log_file"] = rtrim(Config::get('alipayopen.aop_sdk_work_dir'), '\\/') . '/' . "logs/aop_comm_err_" . $this->appId . "_" . date("Y-m-d") . ".log";
