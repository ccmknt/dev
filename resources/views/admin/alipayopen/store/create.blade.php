                    ...
                    <div class="col-sm-12">
                        <form action="{{url('admin/alipayopen/store')}}" method="post">
                            ...
                            <input type="hidden" id="store_id" name="store_id"
                                   value="<?php echo 's' . date('YmdHis', time())?>">
                            <input type="hidden" id="app_auth_token" name="app_auth_token"
                                   value="<?php echo $_GET['app_auth_token']?>">
                            ...
                            <div class="form-group">
                                <label>品牌名</label>
                                <input msg="品牌名" id="istrue"  placeholder="不填写则默认为“其它品牌”" class="form-control" name="brand_name" id="brand_name" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                <label>主店名称</label>
                                <input msg="主店名称" required="required" placeholder="比如：肯德基；主店名里不要包含分店名" class="form-control" name="main_shop_name" id="main_shop_name"
                                       type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>分店名称</label>
                                <input msg="分店名称" required="required" placeholder="比如：万塘路店，与主门店名合并在客户端显示为：肯德基(万塘路店)" class="form-control"
                                       name="branch_shop_name" id="branch_shop_name" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>门店地址</label>
                                <div id="description">
                                    <select style="width:100px; " onchange="sech(this.id)" id="province_code" name="province_code">
                            ...
                            <div class="form-group">
                                <label>详细地址</label>
                                <input msg="详细地址" required="required" placeholder="不含省市区。门店详细地址按规范格式填写地址，以免影响门店搜索及活动报名：例1：道路+门牌号，“人民东路18号”"
                                       class="form-control" name="address" id="address" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>经度纬度</label>
                                <input msg="经度纬度" required="required" placeholder="经度纬度；最长15位字符（包括小数点）" class="form-control" name="longitude_latitude" id="longitude_latitude"
                                       type="text">
                            ...
                            <div class="form-group">
                                <label>门店电话号码</label>
                                <input msg="门店电话号码" required="required" placeholder="门店电话号码；支持座机和手机，只支持数字和+-号，在客户端对用户展现， 支持多个电话以英文逗号分隔。"
                                       class="form-control" name="contact_number" id="contact_number" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>门店店长电话号码</label>
                                <input placeholder="门店店长电话号码；用于接收门店状态变更通知，收款成功通知等通知消息， 不在客户端展示" class="form-control"
                                       name="notify_mobile" id="notify_mobile" type="text">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>门店首图</label>
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload1"  type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload2" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files2"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload3" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files3"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload4" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files4"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>营业时间</label>
                                <input class="form-control" required="required" name="business_time" id="business_time"  type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="wifi" id="wifi" type="text"
                                       placeholder="门店是否支持WIFI，T表示支持，F表示不支持">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>停车</label>
                                <input class="form-control" name="parking" id="parking" type="text" placeholder="T表示支持，F表示不支持">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>门店其他的服务</label>
                                <input class="form-control" name="value_added" id="value_added" type="text"
                                       placeholder="门店其他的服务，门店与用户线下兑现">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>人均消费</label>
                                <input class="form-control" name="avg_price" id="avg_price" type="text"
                                       placeholder="人均消费价格，最少1元，最大不超过99999元">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>营业执照</label>
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload5" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files5"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>营业执照上名称</label>
                                <input type="text" required="required" size="50" name="licence_name" id="licence_name" placeholder="门店营业执照名称">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>营业执照编号</label>
                                <input type="text" required="required" size="50" name="licence_code" id="licence_code" placeholder="门店营业执照编号">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>营业执照过期时间</label>
                                <input type="text" placeholder="营业执照过期时间格式：2020-03-20" size="50" name="licence_expires" id="licence_expires" >
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>许可证</label>
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload6" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files6"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload7" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files7"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- 图片上传按钮 -->
                                <input id="fileupload8" type="file" name="image" data-url="{{route('upload')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files8"></div><div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>是否有包厢</label>
                                <input class="form-control" name="box" id="box" type="text" placeholder="门店是否有包厢，T表示有，F表示没有">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>是否有无烟区</label>
                                <input class="form-control" name="no_smoking" id="no_smoking" type="text"
                                       placeholder="T表示有无烟区，F表示没有无烟区">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>机具号</label>
                                <input class="form-control" name="implement_id" id="implement_id" type="text"
                                       placeholder="机具号，多个之间以英文逗号分隔">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>是否在其他平台开店</label>
                                <input class="form-control" name="is_operating_online" id="is_operating_online" type="text"
                                       placeholder="是否在其他平台开店，T表示有开店，F表示未开店。">
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label>其他平台开店的店铺链接url</label>
                                <input class="form-control" name="online_url" id="online_url" type="text"
    ...
    <script>
        function addpost() {
           $.post("{{url('admin/alipayopen/store')}}",
                   {_token: '{{csrf_token()}}',app_auth_token:$("#app_auth_token").val(),store_id:$("#store_id").val(),category_id:$("#category_id").val()
                       ,brand_name:$("#brand_name").val(),brand_logo:$("#brand_logo").val(),main_shop_name:$("#main_shop_name").val()
                       ,branch_shop_name:$("#branch_shop_name").val(),province_code:$("#province_code").val(),city_code:$("#city_code").val()
                       ,district_code:$("#district_code").val(),address:$("#address").val(),longitude_latitude:$("#longitude_latitude").val()
                       ,contact_number:$("#contact_number").val(),notify_mobile:$("#notify_mobile").val()
                       ,main_image:$("#main_image").val(),audit_images1:$("#audit_images1").val(),audit_images2:$("#audit_images2").val(),audit_images3:$("#audit_images3").val(),business_time:$("#business_time").val()
                       ,wifi:$("#wifi").val(),parking:$("#parking").val(),value_added:$("#value_added").val()
