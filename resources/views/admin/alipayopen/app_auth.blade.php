    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="well well-lg">
                <h3>
                    不开店只签约当面付流程
                </h3>   1.商户扫描上面这个二维码授权   2.支付宝后台签约当面付产品（<a href="https://openhome.alipay.com/isv/isvMerchantManage.htm" target="_blank">https://openhome.alipay.com/isv/isvMerchantManage.htm</a>）   3.软件生成收款码
            </div>
        </div>
    </div>
</div>
