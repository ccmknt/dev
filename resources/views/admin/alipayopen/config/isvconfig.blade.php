                    ...
                    <div class="col-sm-12">
                       ...
                       <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" size="50" name="rsaPrivateKeyFilePath" value="{{$c['rsaPrivateKeyFilePath']}}" id="rsaPrivateKeyFilePath">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload" type="file" name="file" data-url="{{route('uploadfile')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" size="50" name="rsaPublicKeyFilePath" value="{{$c['rsaPublicKeyFilePath']}}" id="rsaPublicKeyFilePath">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload1" type="file"  name="file" data-url="{{route('uploadfile')}}" data-form-data='{"_token": "{{csrf_token()}}"}' multiple="true">
                                <!-- 图片展示模块 -->
