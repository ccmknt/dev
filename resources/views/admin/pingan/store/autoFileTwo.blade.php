                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <label>经营许可证</label>
                                <input type="hidden" value="{{$StoreInfos['business_certificate']}}" required="required" size="50" name="business_certificate"
                                ...
                                <input id="fileupload2" type="file" name="image"
                                       ...
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files2"><img class="images_zone" width="30px" src="{{$StoreInfos['business_certificate']}}"></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>店内照片1</label>
                                <input type="hidden" value="{{$StoreInfos['audit_images1']}}" required="required" size="50" name="audit_images1"
                                       id="audit_images1">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload6" type="file" name="image"
                                       ...
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files6"><img class="images_zone" width="30px" src="{{$StoreInfos['audit_images1']}}"></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>店内照片2</label>
                                <input type="hidden" required="required" value="{{$StoreInfos['audit_images2']}}" size="50" name="audit_images2"
                                       id="audit_images2">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload7" type="file" name="image"
                                       ...
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files7"><img class="images_zone" width="30px" src="{{$StoreInfos['audit_images2']}}"></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
                            ...
                            <div class="form-group">
                                <label>店内照片3</label>
                                <input type="hidden" required="required" value="{{$StoreInfos['audit_images3']}}" size="50" name="audit_images3"
                                       id="audit_images3">
                                <!-- 图片上传按钮 -->
                                <input id="fileupload8" type="file" name="image"
                                       ...
                                       multiple="true">
                                <!-- 图片展示模块 -->
                                <div class="files8"><img class="images_zone" width="30px" src="{{$StoreInfos['audit_images3']}}"></div>
                                <div style="clear:both;"></div>
                                <!-- 图片上传进度条模块 -->
