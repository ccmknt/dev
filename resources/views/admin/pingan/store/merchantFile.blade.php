                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <a class="fancybox" href="{{$files['licence']}}" title="营业执照">
                            <img alt="没有营业执照照片" style="max-width: 300px" src="{{$files['licence']}}">
                        </a>
                        <a class="fancybox" href="{{$files['main_image']}}" title="门头照">
                            <img alt="没有门头照" style="max-width: 300px" src="{{$files['main_image']}}">
                        </a>
                        <a class="fancybox" href="{{$files['sfz1']}}" title="身份证正面">
                            <img alt="没有身份证正面" style="max-width: 300px" src="{{$files['sfz1']}}">
                        </a>
                        <a class="fancybox" href="{{$files['sfz2']}}" title="身份证反面">
                            <img alt="没有身份证反面" style="max-width: 300px" src="{{$files['sfz2']}}">
                        </a>
                    </div>
                </div>
            </div>
